          ...
          <div class="col-lg-12 d-flex justify-content-center">
            ...
            if (is_dir($dir)){
              if ($dh = opendir($dir)){
                ...
                {
                  $file_display1 = ['html', 'css', 'doc','txt', 'htm','xhtml','jsp','js','php','xml','svg','jpg', 'jpeg', 'png', 'gif'];
...
if (is_dir($dir)){
  if ($dh = opendir($dir)){
    while (($filed = readdir($dh)) !== false)
    {
      ...
      $file_display1 = ['html', 'css', 'doc', 'htm','xhtml','jsp','js','php','xml','svg','jpg', 'jpeg', 'png', 'gif','txt','jpeg','png'];
      $file_type1 = pathinfo($filed, PATHINFO_EXTENSION);
      if (in_array($file_type1, $file_display1) == false)
      {
        $fileds = str_replace(' ', '‎‏‏‎-', $filed);
      if($fileds != "." && $fileds != ".." && $fileds[0] != '.' ) 
      {
        echo "<div class=\"col-12 portfolio-item ".$fileds." \">";
        
        $directory = "gallery/description/";
        if(is_dir($directory))
        {
        $dirr = opendir($directory);
       while (($files = readdir($dirr)) !== false) 
       {
      ...
      <?php
       ...
       echo "";
        ...
        echo "</div></br>";
foreach (ListFiles2("gallery/$filed") as $key=>$file)
{
  ...
  echo "<div class=\"box\"><a href=\"$file\" data-gall='portfolioGallery' class=\"venobox preview-link\" title='Title'><img style='height:250px;width:600px'class='img-fluid'  src=\"$file\"/></a></div>";
